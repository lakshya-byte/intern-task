  ...
  return (
    <div ref={container} className="flex min-h-screen items-center justify-center p-4 bg-[#05050A]">
      ...
      <div className="w-full max-w-[400px] relative z-10">
        ...
        {/* Logo */}
        <div className="auth-anim mb-10 flex flex-col items-center">
          <Link href="/" className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-zinc-800 to-zinc-900 border border-white/10 shadow-xl transition-transform hover:scale-105">
            <Zap size={28} className="text-white" />
          </Link>
          <h1 className="text-3xl font-bold text-white tracking-tight">Welcome back</h1>
          <p className="mt-2 text-sm text-zinc-400">Enter your details to sign in.</p>
        </div>

        <form onSubmit={handleSubmit} className="auth-anim space-y-5 rounded-3xl border border-white/10 bg-white/[0.02] p-8 backdrop-blur-xl shadow-2xl">
          {/* Email */}
          <div>
            <label className="mb-2 block text-xs font-semibold uppercase tracking-wider text-zinc-400">Email Address</label>
            <input
              type="email"
          ...
          <div>
            <div className="mb-2 flex items-center justify-between">
              ...
              <Link href="#" className="text-xs font-medium text-blue-400 hover:text-blue-300 transition-colors">Forgot?</Link>
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-white px-4 py-3.5 text-sm font-semibold text-black transition-transform hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:pointer-events-none"
          >
